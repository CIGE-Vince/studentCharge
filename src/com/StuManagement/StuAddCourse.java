...
import javax.sql.*;
public class StuAddCourse extends JFrame implements ActionListener
{
	private Connection conn;
	private Statement stmt;
	private ResultSet rs;
	public String host="127.0.0.1:3306";
	public String coll_id="01";
	...
	public StuAddCourse()
	{
		...
		int w=370;
		int h=350;
		this.setBounds(centerX-200,centerY-h/3-80,w,h);//设置窗体出现在屏幕中央
	...
	{
		StuAddCourse stuAddCourse=new StuAddCourse();
	}
}